      ...
      <div className="layout-container">
        ...
        <div className="grid-container">
          <div className="house-container">
            <img src={Housing_1} alt="amenities images" onClick={() => navigate("/")}/>
            <h3>
              U place
            </h3>
            <p>
              U Village | $1750/month | 2b2b
            </p>
          </div>
          <div className="house-container">
            <img src={Housing_2} alt="amenities images" onClick={() => navigate("/")}/>
            <h3>
              Cielo
            </h3>
            <p>
              Lake City | $1800/month | studio
            </p>
          </div>
          <div className="house-container">
            <img src={Housing_3} alt="amenities images" onClick={() => navigate("/")}/>
            <h3>
              Trailside
            </h3>
            <p>
              U Village | $2100/month | 1b1b
            </p>
          </div>
          <div className="house-container">
            <img src={Housing_4} alt="amenities images" onClick={() => navigate("/")}/>
            <h3>
              Avaron
            </h3>
            <p>
              Queen Anne | $2270/month | studio
            </p>
          </div>
        </div>
