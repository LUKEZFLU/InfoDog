...
export const PlatformYoutubeShapeSquareColoredTrue = ({ className }) => {
  return (
    <svg
      className={`platform-youtube-shape-square-colored-true ${className}`}
      fill="none"
      height="48"
      viewBox="0 0 48 48"
      width="48"
